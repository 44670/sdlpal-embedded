...
#define PAL_SRAM_TILE_SLOT_BYTES 65536u
...
#define PAL_PSRAM_SAVE_STATE_BYTES (256u * 1024u)
...
#define PAL_PSRAM_BATTLE_SCENE_BYTES (320u * 200u)
#ifndef PAL_PSRAM_SFX_BANK_BYTES
#define PAL_PSRAM_SFX_BANK_BYTES (4u * 1024u * 1024u)
#endif
#define PAL_PSRAM_TEXT_MISC_BYTES (256u * 1024u)
#define PAL_PSRAM_SPRITE_PIN_BYTES (1280u * 1024u)
...
#define PAL_SRAM_DECLARED_BYTES \
    (PAL_SRAM_FRAMEBUFFER_BYTES + PAL_SRAM_BIG_BUFFER_BYTES + PAL_SRAM_TILE_SLOT_BYTES + PAL_SRAM_AUDIO_BYTES + \
...
#define PAL_PSRAM_DECLARED_BYTES \
    (PAL_PSRAM_SAVE_STATE_BYTES + PAL_PSRAM_MAP_TILES_BYTES + PAL_PSRAM_GOP_COPY_BYTES + \
     ...
     PAL_PSRAM_EFFECT_BYTES + PAL_PSRAM_FBP_BACKGROUND_BYTES + PAL_PSRAM_BATTLE_SCENE_BYTES + PAL_PSRAM_SFX_BANK_BYTES + \
...
extern uint8_t pal_sram_tile_slot[PAL_SRAM_TILE_SLOT_BYTES];
...
extern uint8_t pal_psram_battle_scene[PAL_PSRAM_BATTLE_SCENE_BYTES];
