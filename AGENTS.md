...
- Under the same contract defines, `uigame.c` FBP menu backgrounds use a static `uint8_t` PSRAM buffer (`pal_psram_uigame_background`) or caller-provided static buffers and require already-native 64KB FBP chunks.
